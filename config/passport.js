        ...
        process.nextTick(function() {
            ...
            if (!req.user) {
                User.findOne({ 'account.email' :  email }, function(err, user) {
                    ...
                    if (user) {
                        return done(null, false, req.flash('signupMessage', 'Tài khoản này đã được đăng kí.'));
                    } else {
            ...
            // if the user is logged in but has no local account...
            } else if ( !req.user.account.email ) {
                ...
                User.findOne({ 'account.email' :  email }, function(err, user) {
                    ...
                    if (user) {
                        return done(null, false, req.flash('loginMessage', 'Tài khoản này đã được đăng kí.'));
